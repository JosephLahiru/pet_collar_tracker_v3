...
public class UserDeviceLocationHistoryMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_device_location_history_map);
        ...
        TextView locationHistoryTextView = (TextView) findViewById(R.id.locationHistoryTextView);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try
                {
                    ...
                    //Toast.makeText(UserDeviceLocationHistoryMapActivity.this, Integer.toString(longitude.length), Toast.LENGTH_SHORT).show();
                    ...
                    for (int j = 0; j < longitude.length; j++) {
                        ...
                        System.out.println(curr_lat + " " + curr_long + " " + curr_time);

                        mMap.addMarker(new MarkerOptions()
                                .position(latLng)
                                .title("Device " + devID + " : " + curr_lat + " , " + curr_long + " Time : " + curr_time)
