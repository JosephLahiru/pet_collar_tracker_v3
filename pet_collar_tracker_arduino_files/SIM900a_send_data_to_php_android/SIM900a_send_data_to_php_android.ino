...
void loop() {
  ...
  if (currentMillis - previousMillis > interval) {
    ...
    if (latitude == "0.000000" && longitude == "0.000000") {
      Serial.println("GPS Module booting up.. Please Wait.");
    }
    else {
      post_to_firebase();
    }
...
void post_to_firebase()
{
  ...
  SIM900a.println("AT+HTTPPARA=\"URL\", https://petcollartrackerfirebase.000webhostapp.com/write_data.php?id=1&long=" + longitude + "&lati=" + latitude);
  waitResponse();
  delay(DELAY_MS);
